...
//                    return dd($s,$value->$s);
                    $a[$colname] = $value[array_search($s, $excelRowHesder)];
                }
            }
            ...
            try {
                ...
                $staticFiled = \Illuminate\Support\Facades\Session::get('staticFiled');
                $dataCols = array_merge($staticFiled, $a);

                DB::table($this->table)->insert($dataCols);
                Cache::increment('success_' . $file_md5);
//                Session::forget('staticFiled');
            } catch (\Exception $e) {
                $e = (string)$e;
